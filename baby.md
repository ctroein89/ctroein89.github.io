...
[Baby Gear Lab ran crash tests on infant seats](https://www.babygearlab.com/topics/vehicle-safety/best-infant-car-seat). The goal is to have the impact of the crash to be spread over the longest period of time. But, that crash test data assumes that the baby is properly positioned within their car seat. In order to ensure that the baby is properly positioned, the car seat has to be comfortable for the baby, which in turn means that the safest car seat needs to balance deceleration with some comfort.

The foam in baby car seats have an expiration date. Never use a car seat that's been involved in a moderate or serious crash (and think twice about "light" crashes), and don't accept old old hand-me-downs (practically new is okay). Car seats are about safety, and never cut costs with safety.

The guidance that I've read says to keep babies facing backwards for as long as possible. Their weight will be the primary determinant for when you have to change position and car seat, but a tall baby may outgrow their current seat. At the time that I was doing my research, the best guidance from the US government was to follow whatever the latest guidance from Sweden was.

### LATCH
The safest way to install a car seat is with the [LATCH system](https://www.health.ny.gov/publications/0625/): basically all modern cars have LATCH attachment points. The goal of the LATCH system is to ensure that all cars have a standardized and easy method for installing car seats. The standard configuration is for cars to support 2 car seats at the same time, but some cars support 3 car seats next to each other.

Be sure to look at the dimensions of your car before choosing a LATCH car seat: some cars will claim 3 LATCH attachement points, but aren't wide enough to accomodate 3 regular-width car seats (and some car seats with claim support for 3-abreast seating, without being any narrower). However, don't pre-emptively buy narrower car seats, since wider car seats can provide better padding in the event of a side collision (or may simply fit a fatter baby).

Most car seats integrate into the LATCH system via a heavy base. If you only drive your car, the base ensures that the car seat is as light as possible, while still getting the benefits of LATCH. For a baby taken via taxi or Uber to doctor's appointments, the car seat should ideally have the LATCH system integrated into the car seat.

I've settled on the [Nuna Urbn Flex system](https://nunababy.com/usa/pipa-urbn-flex-system?color_ref=16366) as my preferred car seat, because it has the LATCH system built into the car seat and since Nuna makes generally safe and comfortable car seat. The Nuna Urbn must be purchased as part of a bundle (along with a stroller), which is why I didn't initially find it when I was looking for a baby car seat.

The [Joie Mint Latch](https://joiebaby.com/us/mint-latch-integrated-rigid-latch#color=683) has been recommended to me for similar reasons.

### Belt routing
If you can't get a car seat with an integrated LATCH system in the seat, be aware of belt routing options. Belt routing refers to the path that the seatbelt takes around the car seat to secure it.
...
When your child outgrows the infant car seat, the car seats will require being installed first. At this point, I think a heavier convertable car seat is fine.

When flying, you'll go back to wanting the lightest car seat available, since you will be carrying it. The [Cosco Kids Scenera from Walmart](https://www.walmart.com/ip/CK-SCENERA-CC-SIP-NT/9321554473) is a perfectly fine choice.

## Stroller
The car seat will inform one of the strollers that you should pick. If you bought the Nuna Urbn bundle, part of the stroller decision making is already done for you.

Most stroller brands are interoperateable with car seats from other brands when used with the right adapters, but double-check the attachment compatability before you buy.

As your baby grows, the stroller requirements are going to change. My baby was born in the winter, so she only went outside to go to the neighborhood peadatrician in an Uber. Now that she's older and the weather is warmer, we walk almost everywhere with her, using the stroller as a cargo carrier.

### Weight, Suspension and Folded Carrying
A light weight stroller is easier to lift, but a heavy stroller provides a more comfortable ride for your baby.

For picking a "light" stroller, try picking it up once folded. In my experience, that's when a stroller is most difficult to carry, and when weight becomes most apparent. To make an analogy, the folded stroller works like a kettlebell, trying to pull you out of balance.
...
Two-part folder kinda sucks, especially if it needs two hands to do so. A stroller like this will basically assume that you live in an elevator building, and don't fold your stroller.
...
If you formula-feed, keeping your formula-making area clean will be an important concern. Take a look at a bottle washer to keep everything as clean as possible.
